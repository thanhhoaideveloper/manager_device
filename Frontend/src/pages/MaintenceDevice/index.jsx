...
const RequestAddDevice = () =>{
  ...
  const columns = [
    ...
    { field: "name", headerName: "Thiết bị", flex: 1, headerAlign: 'center',align: 'center'},
    { field: "code", headerName: "Ngày kiểm tra", flex: 1, headerAlign: 'center',align: 'center', },
    {
          field: "is_active",
  ...
  return (
    <Box m="10px">
      <Header title="Kiểm tra" subtitle="Kiểm tra thiết bị" />
      <Box 
        height="75vh"
        sx={{
          "& .MuiDataGrid-root": {
